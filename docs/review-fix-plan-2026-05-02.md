# Review Fix Plan: 2026-05-02 Static Review Follow-Up

This document tracks stale-or-current static review findings that still need
evidence-driven handling. Each item must follow:
...
| Finding | Status | Evidence Path | Planned Action |
| --- | --- | --- | --- |
...
1. L1 restoration dual-box red test and fix.
2. README/API consistency patch.
3. Post-line-search stale residual contract test and cleanup.
4. Restoration success semantics.
5. Finite validation hardening.
