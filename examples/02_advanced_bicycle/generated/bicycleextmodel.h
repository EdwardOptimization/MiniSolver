...
struct BicycleExtModel {
    ...
    static void compute_dynamics(KnotPoint<T, NX, NU, NC, NP>& kp, IntegratorType type, double dt)
    {
        ...
        case IntegratorType::RK4_IMPLICIT: {
            ...
            kp.f_resid(2) = theta
                + tmp_d22 * (kappa * v + tmp_d17 * tmp_d32 + tmp_d2 * tmp_d32 + tmp_d33 * tmp_d8);
            ...
            kp.A(0, 4) = tmp_d22
                * (tmp_d0 - tmp_d11 * tmp_d39 - tmp_d12 * tmp_d28 + tmp_d14 + tmp_d21
                    - tmp_d3 * tmp_d36 + tmp_d6);
            kp.A(0, 5) = tmp_d22
                * (dt * tmp_d14 + 1.0 * dt * tmp_d20 + 1.0 * dt * tmp_d5 - tmp_d25 * tmp_d42
                    - tmp_d28 * tmp_d44 - tmp_d45 * tmp_d46);
            kp.A(1, 1) = 1;
            kp.A(1, 2) = tmp_d23;
            kp.A(1, 3) = tmp_d22 * (tmp_d15 * tmp_d37 + tmp_d18 * tmp_d48 + tmp_d35 * tmp_d47);
            kp.A(1, 4) = tmp_d22
                * (tmp_d11 * tmp_d48 + tmp_d12 * tmp_d15 + tmp_d24 + tmp_d26 + tmp_d27
                    + tmp_d3 * tmp_d47 + tmp_d30);
            kp.A(1, 5) = tmp_d22
                * (dt * tmp_d27 + tmp_d15 * tmp_d44 + tmp_d36 + tmp_d38 + tmp_d42 * tmp_d5
                    + tmp_d46 * tmp_d49);
            kp.A(2, 2) = 1;
            ...
            kp.B(0, 1) = tmp_d22
                * (0.5 * tmp_d14 * tmp_d40 + 0.5 * tmp_d20 * tmp_d40 - tmp_d28 * tmp_d54
                    - tmp_d45 * tmp_d55);
            kp.B(1, 0) = tmp_d22 * (tmp_d15 * tmp_d50 + tmp_d20 * tmp_d41 * tmp_d52);
            kp.B(1, 1)
                = tmp_d22 * (tmp_d15 * tmp_d54 + tmp_d27 * tmp_d41 + tmp_d49 * tmp_d55 + tmp_d51);
    ...
    template <typename T, int Mode> static void compute_cost_impl(KnotPoint<T, NX, NU, NC, NP>& kp)
    {
        ...
        kp.cost = pow(a, 2) * w_a + pow(dkappa, 2) * w_dkappa + pow(jerk, 2) * w_jerk
            + pow(kappa, 2) * w_kappa + pow(theta, 2) * w_theta
            + w_pos * (pow(x - x_ref, 2) + pow(y - y_ref, 2)) + w_vel * pow(v - v_ref, 2);
    }
    ...
    static void compute_terminal_cost_impl(KnotPoint<T, NX, NU, NC, NP>& kp)
    {
        ...
        kp.cost = pow(a, 2) * w_a + pow(kappa, 2) * w_kappa + pow(theta, 2) * w_theta
            + w_pos * (pow(x - x_ref, 2) + pow(y - y_ref, 2)) + w_vel * pow(v - v_ref, 2);
    }
        ...
        const MSMat<T, NX, NX>& Vxx, const MSVec<T, NX>& Vx, KnotPoint<T, NX, NU, NC, NP>& kp)
    {
        ...
        kp.Q_bar(0, 4)
            += A_0_0 * tmp_ric10 + A_0_0 * tmp_ric7 + A_0_0 * tmp_ric8 + A_0_0 * tmp_ric9;
        kp.Q_bar(0, 5) += A_0_0 * tmp_ric11 + A_0_0 * tmp_ric12 + A_0_0 * tmp_ric13
            + A_0_0 * tmp_ric14 + A_0_0 * tmp_ric15;
        kp.Q_bar(1, 1) += pow(A_1_1, 2) * P_1_1;
        kp.Q_bar(1, 2) += A_1_1 * tmp_ric16 + A_1_1 * tmp_ric17 + A_1_1 * tmp_ric18;
        kp.Q_bar(1, 3)
            += A_1_1 * tmp_ric19 + A_1_1 * tmp_ric20 + A_1_1 * tmp_ric21 + A_1_1 * tmp_ric22;
        kp.Q_bar(1, 4)
            += A_1_1 * tmp_ric23 + A_1_1 * tmp_ric24 + A_1_1 * tmp_ric25 + A_1_1 * tmp_ric26;
        kp.Q_bar(1, 5) += A_1_1 * tmp_ric27 + A_1_1 * tmp_ric28 + A_1_1 * tmp_ric29
            + A_1_1 * tmp_ric30 + A_1_1 * tmp_ric31;
        kp.Q_bar(2, 2) += A_0_2 * tmp_ric32 + A_1_2 * tmp_ric33 + A_2_2 * tmp_ric34;
        kp.Q_bar(2, 3) += A_0_3 * tmp_ric32 + A_1_3 * tmp_ric33 + A_2_3 * tmp_ric34
            + A_3_3 * (A_0_2 * P_0_3 + A_1_2 * P_1_3 + A_2_2 * P_2_3);
        kp.Q_bar(2, 4)
            += A_0_4 * tmp_ric32 + A_1_4 * tmp_ric33 + A_2_4 * tmp_ric34 + A_4_4 * tmp_ric35;
        kp.Q_bar(2, 5) += A_0_5 * tmp_ric32 + A_1_5 * tmp_ric33 + A_2_5 * tmp_ric34
            + A_4_5 * tmp_ric35 + A_5_5 * (A_0_2 * P_0_5 + A_1_2 * P_1_5 + A_2_2 * P_2_5);
        kp.Q_bar(3, 3) += A_0_3 * tmp_ric36 + A_1_3 * tmp_ric37 + A_2_3 * tmp_ric38
            + A_3_3 * (A_0_3 * P_0_3 + A_1_3 * P_1_3 + A_2_3 * P_2_3 + A_3_3 * P_3_3);
        kp.Q_bar(3, 4)
            += A_0_4 * tmp_ric36 + A_1_4 * tmp_ric37 + A_2_4 * tmp_ric38 + A_4_4 * tmp_ric39;
        kp.Q_bar(3, 5) += A_0_5 * tmp_ric36 + A_1_5 * tmp_ric37 + A_2_5 * tmp_ric38
            + A_4_5 * tmp_ric39
            + A_5_5 * (A_0_3 * P_0_5 + A_1_3 * P_1_5 + A_2_3 * P_2_5 + A_3_3 * P_3_5);
        kp.Q_bar(4, 4)
            += A_0_4 * tmp_ric40 + A_1_4 * tmp_ric41 + A_2_4 * tmp_ric42 + A_4_4 * tmp_ric43;
        kp.Q_bar(4, 5) += A_0_5 * tmp_ric40 + A_1_5 * tmp_ric41 + A_2_5 * tmp_ric42
            + A_4_5 * tmp_ric43
            + A_5_5 * (A_0_4 * P_0_5 + A_1_4 * P_1_5 + A_2_4 * P_2_5 + A_4_4 * P_4_5);
        kp.Q_bar(5, 5) += A_0_5 * (tmp_ric11 + tmp_ric12 + tmp_ric13 + tmp_ric14 + tmp_ric15)
            + A_1_5 * (tmp_ric27 + tmp_ric28 + tmp_ric29 + tmp_ric30 + tmp_ric31)
            + A_2_5
                * (A_0_5 * P_0_2 + A_1_5 * P_1_2 + A_2_5 * P_2_2 + A_4_5 * P_2_4 + A_5_5 * P_2_5)
            + A_4_5
                * (A_0_5 * P_0_4 + A_1_5 * P_1_4 + A_2_5 * P_2_4 + A_4_5 * P_4_4 + A_5_5 * P_4_5)
            + A_5_5
                * (A_0_5 * P_0_5 + A_1_5 * P_1_5 + A_2_5 * P_2_5 + A_4_5 * P_4_5 + A_5_5 * P_5_5);
        kp.R_bar(0, 0)
            += B_0_0 * tmp_ric44 + B_1_0 * tmp_ric45 + B_2_0 * tmp_ric46 + B_3_0 * tmp_ric47;
        kp.R_bar(0, 1) += B_0_1 * tmp_ric44 + B_1_1 * tmp_ric45 + B_2_1 * tmp_ric46
            + B_4_1 * tmp_ric48 + B_5_1 * tmp_ric49;
        kp.R_bar(1, 1) += B_0_1 * tmp_ric50 + B_1_1 * tmp_ric51 + B_2_1 * tmp_ric52
            + B_4_1 * tmp_ric53 + B_5_1 * tmp_ric54;
        kp.H_bar(0, 0) += A_0_0 * tmp_ric44;
        kp.H_bar(0, 1) += A_1_1 * tmp_ric45;
        kp.H_bar(0, 2) += A_0_2 * tmp_ric44 + A_1_2 * tmp_ric45 + A_2_2 * tmp_ric46;
        kp.H_bar(0, 3)
            += A_0_3 * tmp_ric44 + A_1_3 * tmp_ric45 + A_2_3 * tmp_ric46 + A_3_3 * tmp_ric47;
        kp.H_bar(0, 4)
            += A_0_4 * tmp_ric44 + A_1_4 * tmp_ric45 + A_2_4 * tmp_ric46 + A_4_4 * tmp_ric48;
        kp.H_bar(0, 5) += A_0_5 * tmp_ric44 + A_1_5 * tmp_ric45 + A_2_5 * tmp_ric46
            + A_4_5 * tmp_ric48 + A_5_5 * tmp_ric49;
        kp.H_bar(1, 0) += A_0_0 * tmp_ric50;
        kp.H_bar(1, 1) += A_1_1 * tmp_ric51;
        kp.H_bar(1, 2) += A_0_2 * tmp_ric50 + A_1_2 * tmp_ric51 + A_2_2 * tmp_ric52;
        kp.H_bar(1, 3) += A_0_3 * tmp_ric50 + A_1_3 * tmp_ric51 + A_2_3 * tmp_ric52
            + A_3_3
                * (B_0_1 * P_0_3 + B_1_1 * P_1_3 + B_2_1 * P_2_3 + B_4_1 * P_3_4 + B_5_1 * P_3_5);
        kp.H_bar(1, 4)
            += A_0_4 * tmp_ric50 + A_1_4 * tmp_ric51 + A_2_4 * tmp_ric52 + A_4_4 * tmp_ric53;
        kp.H_bar(1, 5) += A_0_5 * tmp_ric50 + A_1_5 * tmp_ric51 + A_2_5 * tmp_ric52
            + A_4_5 * tmp_ric53 + A_5_5 * tmp_ric54;
